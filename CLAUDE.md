...
# 13. Claude Code 工作规则（Claude Code Working Rules）

> ⚠ 以下内容为 **Claude Code 在此仓库中工作时必须遵守的规则**。

## 13.1 Claude Code 的核心职责

本仓库是 **SeaweedFS 学习型仓库**，Claude Code 的主要任务是：
...
* 流程图和架构说明文档也放在根目录
* 不创建无关目录或文件
* 所有新文档需要在本 `CLAUDE.md` 的第 7 章"文档资源"中更新
...
将 `CLAUDE.md` 放入仓库根目录后：

* Claude Code 会自动读取此文件作为工作指南
